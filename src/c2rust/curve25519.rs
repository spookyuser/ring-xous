...
unsafe extern "C" fn fiat_25519_addcarryx_u26(
    ...
    let x1: uint32_t = (arg1 as std::os::raw::c_uint)
        .wrapping_add(arg2)
        .wrapping_add(arg3);
    let x2: uint32_t = x1 & 0x3ffffff as std::os::raw::c_uint;
    let x3: fiat_25519_uint1 = (x1 >> 26 as std::os::raw::c_int) as fiat_25519_uint1;
    *out1 = x2;
    *out2 = x3;
}
unsafe extern "C" fn fiat_25519_subborrowx_u26(
    ...
    let x2: fiat_25519_int1 = (x1 >> 26 as std::os::raw::c_int) as fiat_25519_int1;
    let x3: uint32_t = x1 as std::os::raw::c_uint & 0x3ffffff as std::os::raw::c_uint;
    *out1 = x3;
...
unsafe extern "C" fn fiat_25519_addcarryx_u25(
    ...
    let x1: uint32_t = (arg1 as std::os::raw::c_uint)
        .wrapping_add(arg2)
        .wrapping_add(arg3);
    let x2: uint32_t = x1 & 0x1ffffff as std::os::raw::c_uint;
    let x3: fiat_25519_uint1 = (x1 >> 25 as std::os::raw::c_int) as fiat_25519_uint1;
    *out1 = x2;
    *out2 = x3;
}
unsafe extern "C" fn fiat_25519_subborrowx_u25(
    ...
    let x1: int32_t =
        arg2.wrapping_sub(arg1 as std::os::raw::c_uint) as int32_t - arg3 as int32_t;
    let x2: fiat_25519_int1 = (x1 >> 25 as std::os::raw::c_int) as fiat_25519_int1;
    let x3: uint32_t = x1 as std::os::raw::c_uint & 0x1ffffff as std::os::raw::c_uint;
    *out1 = x3;
    *out2 = (0 as std::os::raw::c_int - x2 as std::os::raw::c_int) as fiat_25519_uint1;
}
unsafe extern "C" fn fiat_25519_cmovznz_u32(
    ...
    let x1: fiat_25519_uint1 = (arg1 != 0) as std::os::raw::c_int as fiat_25519_uint1;
    let x2: uint32_t = (0 as std::os::raw::c_int - x1 as std::os::raw::c_int) as fiat_25519_int1
...
unsafe extern "C" fn fiat_25519_carry_mul(
    ...
    let x1: uint64_t = (*arg1.offset(9 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(9 as std::os::raw::c_int as isize))
                .wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x2: uint64_t = (*arg1.offset(9 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(8 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x3: uint64_t = (*arg1.offset(9 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(7 as std::os::raw::c_int as isize))
                .wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x4: uint64_t = (*arg1.offset(9 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(6 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x5: uint64_t = (*arg1.offset(9 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(5 as std::os::raw::c_int as isize))
                .wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x6: uint64_t = (*arg1.offset(9 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(4 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x7: uint64_t = (*arg1.offset(9 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(3 as std::os::raw::c_int as isize))
                .wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x8: uint64_t = (*arg1.offset(9 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(2 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x9: uint64_t = (*arg1.offset(9 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(1 as std::os::raw::c_int as isize))
                .wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x10: uint64_t = (*arg1.offset(8 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(9 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x11: uint64_t = (*arg1.offset(8 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(8 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x12: uint64_t = (*arg1.offset(8 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(7 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x13: uint64_t = (*arg1.offset(8 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(6 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x14: uint64_t = (*arg1.offset(8 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(5 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x15: uint64_t = (*arg1.offset(8 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(4 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x16: uint64_t = (*arg1.offset(8 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(3 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x17: uint64_t = (*arg1.offset(8 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(2 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x18: uint64_t = (*arg1.offset(7 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(9 as std::os::raw::c_int as isize))
                .wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x19: uint64_t = (*arg1.offset(7 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(8 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x20: uint64_t = (*arg1.offset(7 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(7 as std::os::raw::c_int as isize))
                .wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x21: uint64_t = (*arg1.offset(7 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(6 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x22: uint64_t = (*arg1.offset(7 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(5 as std::os::raw::c_int as isize))
                .wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x23: uint64_t = (*arg1.offset(7 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(4 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x24: uint64_t = (*arg1.offset(7 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(3 as std::os::raw::c_int as isize))
                .wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x25: uint64_t = (*arg1.offset(6 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(9 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x26: uint64_t = (*arg1.offset(6 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(8 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x27: uint64_t = (*arg1.offset(6 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(7 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x28: uint64_t = (*arg1.offset(6 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(6 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x29: uint64_t = (*arg1.offset(6 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(5 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x30: uint64_t = (*arg1.offset(6 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(4 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x31: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(9 as std::os::raw::c_int as isize))
                .wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x32: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(8 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x33: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(7 as std::os::raw::c_int as isize))
                .wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x34: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(6 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x35: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(5 as std::os::raw::c_int as isize))
                .wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x36: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(9 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x37: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(8 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x38: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(7 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x39: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(6 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x40: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(9 as std::os::raw::c_int as isize))
                .wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x41: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(8 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x42: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(7 as std::os::raw::c_int as isize))
                .wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x43: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(9 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x44: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(8 as std::os::raw::c_int as isize))
                .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x45: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(9 as std::os::raw::c_int as isize))
                .wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x46: uint64_t = (*arg1.offset(9 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(0 as std::os::raw::c_int as isize) as u64);
    let x47: uint64_t = (*arg1.offset(8 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(1 as std::os::raw::c_int as isize) as u64);
    let x48: uint64_t = (*arg1.offset(8 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(0 as std::os::raw::c_int as isize) as u64);
    let x49: uint64_t = (*arg1.offset(7 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(2 as std::os::raw::c_int as isize) as u64);
    let x50: uint64_t = (*arg1.offset(7 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(1 as std::os::raw::c_int as isize))
                .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x51: uint64_t = (*arg1.offset(7 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(0 as std::os::raw::c_int as isize) as u64);
    let x52: uint64_t = (*arg1.offset(6 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(3 as std::os::raw::c_int as isize) as u64);
    let x53: uint64_t = (*arg1.offset(6 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(2 as std::os::raw::c_int as isize) as u64);
    let x54: uint64_t = (*arg1.offset(6 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(1 as std::os::raw::c_int as isize) as u64);
    let x55: uint64_t = (*arg1.offset(6 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(0 as std::os::raw::c_int as isize) as u64);
    let x56: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(4 as std::os::raw::c_int as isize) as u64);
    let x57: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(3 as std::os::raw::c_int as isize))
                .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x58: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(2 as std::os::raw::c_int as isize) as u64);
    let x59: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(1 as std::os::raw::c_int as isize))
                .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x60: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(0 as std::os::raw::c_int as isize) as u64);
    let x61: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(5 as std::os::raw::c_int as isize) as u64);
    let x62: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(4 as std::os::raw::c_int as isize) as u64);
    let x63: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(3 as std::os::raw::c_int as isize) as u64);
    let x64: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(2 as std::os::raw::c_int as isize) as u64);
    let x65: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(1 as std::os::raw::c_int as isize) as u64);
    let x66: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(0 as std::os::raw::c_int as isize) as u64);
    let x67: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(6 as std::os::raw::c_int as isize) as u64);
    let x68: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(5 as std::os::raw::c_int as isize))
                .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x69: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(4 as std::os::raw::c_int as isize) as u64);
    let x70: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(3 as std::os::raw::c_int as isize))
                .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x71: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(2 as std::os::raw::c_int as isize) as u64);
    let x72: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(1 as std::os::raw::c_int as isize))
                .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x73: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(0 as std::os::raw::c_int as isize) as u64);
    let x74: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(7 as std::os::raw::c_int as isize) as u64);
    let x75: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(6 as std::os::raw::c_int as isize) as u64);
    let x76: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(5 as std::os::raw::c_int as isize) as u64);
    let x77: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(4 as std::os::raw::c_int as isize) as u64);
    let x78: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(3 as std::os::raw::c_int as isize) as u64);
    let x79: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(2 as std::os::raw::c_int as isize) as u64);
    let x80: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(1 as std::os::raw::c_int as isize) as u64);
    let x81: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(0 as std::os::raw::c_int as isize) as u64);
    let x82: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(8 as std::os::raw::c_int as isize) as u64);
    let x83: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(7 as std::os::raw::c_int as isize))
                .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x84: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(6 as std::os::raw::c_int as isize) as u64);
    let x85: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(5 as std::os::raw::c_int as isize))
                .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x86: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(4 as std::os::raw::c_int as isize) as u64);
    let x87: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(3 as std::os::raw::c_int as isize))
                .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x88: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(2 as std::os::raw::c_int as isize) as u64);
    let x89: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
            (*arg2.offset(1 as std::os::raw::c_int as isize))
                .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint)
                as u64,
        );
    let x90: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(0 as std::os::raw::c_int as isize) as u64);
    let x91: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(9 as std::os::raw::c_int as isize) as u64);
    let x92: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(8 as std::os::raw::c_int as isize) as u64);
    let x93: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(7 as std::os::raw::c_int as isize) as u64);
    let x94: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(6 as std::os::raw::c_int as isize) as u64);
    let x95: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(5 as std::os::raw::c_int as isize) as u64);
    let x96: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(4 as std::os::raw::c_int as isize) as u64);
    let x97: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(3 as std::os::raw::c_int as isize) as u64);
    let x98: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(2 as std::os::raw::c_int as isize) as u64);
    let x99: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(1 as std::os::raw::c_int as isize) as u64);
    let x100: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg2.offset(0 as std::os::raw::c_int as isize) as u64);
    ...
    let x102: uint64_t = x101 >> 26 as std::os::raw::c_int;
    let x103: uint32_t = (x101 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    ...
    let x114: uint64_t = x113 >> 25 as std::os::raw::c_int;
    let x115: uint32_t = (x113 & 0x1ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x116: uint64_t = x114.wrapping_add(x111);
    let x117: uint64_t = x116 >> 26 as std::os::raw::c_int;
    let x118: uint32_t = (x116 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x119: uint64_t = x117.wrapping_add(x110);
    let x120: uint64_t = x119 >> 25 as std::os::raw::c_int;
    let x121: uint32_t = (x119 & 0x1ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x122: uint64_t = x120.wrapping_add(x109);
    let x123: uint64_t = x122 >> 26 as std::os::raw::c_int;
    let x124: uint32_t = (x122 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x125: uint64_t = x123.wrapping_add(x108);
    let x126: uint64_t = x125 >> 25 as std::os::raw::c_int;
    let x127: uint32_t = (x125 & 0x1ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x128: uint64_t = x126.wrapping_add(x107);
    let x129: uint64_t = x128 >> 26 as std::os::raw::c_int;
    let x130: uint32_t = (x128 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x131: uint64_t = x129.wrapping_add(x106);
    let x132: uint64_t = x131 >> 25 as std::os::raw::c_int;
    let x133: uint32_t = (x131 & 0x1ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x134: uint64_t = x132.wrapping_add(x105);
    let x135: uint64_t = x134 >> 26 as std::os::raw::c_int;
    let x136: uint32_t = (x134 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x137: uint64_t = x135.wrapping_add(x104);
    let x138: uint64_t = x137 >> 25 as std::os::raw::c_int;
    let x139: uint32_t = (x137 & 0x1ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x140: uint64_t = x138.wrapping_mul(0x13 as std::os::raw::c_int as u64);
    let x141: uint64_t = (x103 as u64).wrapping_add(x140);
    let x142: uint32_t = (x141 >> 26 as std::os::raw::c_int) as uint32_t;
    let x143: uint32_t = (x141 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x144: uint32_t = x142.wrapping_add(x115);
    let x145: fiat_25519_uint1 = (x144 >> 25 as std::os::raw::c_int) as fiat_25519_uint1;
    let x146: uint32_t = x144 & 0x1ffffff as std::os::raw::c_uint;
    let x147: uint32_t = (x145 as std::os::raw::c_uint).wrapping_add(x118);
...
unsafe extern "C" fn fiat_25519_carry_square(out1: *mut uint32_t, arg1: *const uint32_t) {
    let x1: uint32_t = (*arg1.offset(9 as std::os::raw::c_int as isize))
        .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint);
    let x2: uint32_t = x1.wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint);
    let x3: uint32_t = (*arg1.offset(9 as std::os::raw::c_int as isize))
        .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint);
    let x4: uint32_t = (*arg1.offset(8 as std::os::raw::c_int as isize))
        .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint);
    let x5: uint64_t = (x4 as uint64_t).wrapping_mul(0x2 as std::os::raw::c_int as u64);
    let x6: uint32_t = (*arg1.offset(8 as std::os::raw::c_int as isize))
        .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint);
    let x7: uint32_t = (*arg1.offset(7 as std::os::raw::c_int as isize))
        .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint);
    let x8: uint32_t = x7.wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint);
    let x9: uint32_t = (*arg1.offset(7 as std::os::raw::c_int as isize))
        .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint);
    let x10: uint32_t = (*arg1.offset(6 as std::os::raw::c_int as isize))
        .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint);
    let x11: uint64_t = (x10 as uint64_t).wrapping_mul(0x2 as std::os::raw::c_int as u64);
    let x12: uint32_t = (*arg1.offset(6 as std::os::raw::c_int as isize))
        .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint);
    let x13: uint32_t = (*arg1.offset(5 as std::os::raw::c_int as isize))
        .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint);
    let x14: uint32_t = (*arg1.offset(5 as std::os::raw::c_int as isize))
        .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint);
    let x15: uint32_t = (*arg1.offset(4 as std::os::raw::c_int as isize))
        .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint);
    let x16: uint32_t = (*arg1.offset(3 as std::os::raw::c_int as isize))
        .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint);
    let x17: uint32_t = (*arg1.offset(2 as std::os::raw::c_int as isize))
        .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint);
    let x18: uint32_t = (*arg1.offset(1 as std::os::raw::c_int as isize))
        .wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint);
    let x19: uint64_t = (*arg1.offset(9 as std::os::raw::c_int as isize) as uint64_t)
    ...
    let x22: uint64_t = (*arg1.offset(7 as std::os::raw::c_int as isize) as u64)
    ...
    let x29: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as u64)
        .wrapping_mul((x2 as uint64_t).wrapping_mul(0x2 as std::os::raw::c_int as u64));
    let x30: uint64_t =
        (*arg1.offset(5 as std::os::raw::c_int as isize) as u64).wrapping_mul(x5);
    let x31: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as u64)
    ...
    let x40: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as u64)
        .wrapping_mul((x2 as uint64_t).wrapping_mul(0x2 as std::os::raw::c_int as u64));
    let x41: uint64_t =
        (*arg1.offset(3 as std::os::raw::c_int as isize) as u64).wrapping_mul(x5);
    let x42: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as u64)
        .wrapping_mul((x8 as uint64_t).wrapping_mul(0x2 as std::os::raw::c_int as u64));
    let x43: uint64_t =
        (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t).wrapping_mul(x12 as u64);
    let x44: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
    ...
    let x46: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
    ...
    let x54: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(*arg1.offset(2 as std::os::raw::c_int as isize) as u64);
    let x55: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as u64)
        .wrapping_mul((x2 as uint64_t).wrapping_mul(0x2 as std::os::raw::c_int as u64));
    let x56: uint64_t =
        (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t).wrapping_mul(x6 as u64);
    let x57: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
    ...
    let x59: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(x14.wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint) as u64);
    let x60: uint64_t =
        (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t).wrapping_mul(x15 as u64);
    let x61: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
    ...
    let x63: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
        .wrapping_mul(
    ...
    let x73: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
    ...
    let x75: uint64_t = x74 >> 26 as std::os::raw::c_int;
    let x76: uint32_t = (x74 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x77: uint64_t =
    ...
    let x87: uint64_t = x86 >> 25 as std::os::raw::c_int;
    let x88: uint32_t = (x86 & 0x1ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x89: uint64_t = x87.wrapping_add(x84);
    let x90: uint64_t = x89 >> 26 as std::os::raw::c_int;
    let x91: uint32_t = (x89 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x92: uint64_t = x90.wrapping_add(x83);
    let x93: uint64_t = x92 >> 25 as std::os::raw::c_int;
    let x94: uint32_t = (x92 & 0x1ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x95: uint64_t = x93.wrapping_add(x82);
    let x96: uint64_t = x95 >> 26 as std::os::raw::c_int;
    let x97: uint32_t = (x95 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x98: uint64_t = x96.wrapping_add(x81);
    let x99: uint64_t = x98 >> 25 as std::os::raw::c_int;
    let x100: uint32_t = (x98 & 0x1ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x101: uint64_t = x99.wrapping_add(x80);
    let x102: uint64_t = x101 >> 26 as std::os::raw::c_int;
    let x103: uint32_t = (x101 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x104: uint64_t = x102.wrapping_add(x79);
    let x105: uint64_t = x104 >> 25 as std::os::raw::c_int;
    let x106: uint32_t = (x104 & 0x1ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x107: uint64_t = x105.wrapping_add(x78);
    let x108: uint64_t = x107 >> 26 as std::os::raw::c_int;
    let x109: uint32_t = (x107 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x110: uint64_t = x108.wrapping_add(x77);
    let x111: uint64_t = x110 >> 25 as std::os::raw::c_int;
    let x112: uint32_t = (x110 & 0x1ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x113: uint64_t = x111.wrapping_mul(0x13 as std::os::raw::c_int as u64);
    let x114: uint64_t = (x76 as u64).wrapping_add(x113);
    let x115: uint32_t = (x114 >> 26 as std::os::raw::c_int) as uint32_t;
    let x116: uint32_t = (x114 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x117: uint32_t = x115.wrapping_add(x88);
    let x118: fiat_25519_uint1 = (x117 >> 25 as std::os::raw::c_int) as fiat_25519_uint1;
    let x119: uint32_t = x117 & 0x1ffffff as std::os::raw::c_uint;
    let x120: uint32_t = (x118 as std::os::raw::c_uint).wrapping_add(x91);
...
unsafe extern "C" fn fiat_25519_carry(out1: *mut uint32_t, arg1: *const uint32_t) {
    let x1: uint32_t = *arg1.offset(0 as std::os::raw::c_int as isize);
    let x2: uint32_t = (x1 >> 26 as std::os::raw::c_int)
        .wrapping_add(*arg1.offset(1 as std::os::raw::c_int as isize));
    let x3: uint32_t = (x2 >> 25 as std::os::raw::c_int)
        .wrapping_add(*arg1.offset(2 as std::os::raw::c_int as isize));
    let x4: uint32_t = (x3 >> 26 as std::os::raw::c_int)
        .wrapping_add(*arg1.offset(3 as std::os::raw::c_int as isize));
    let x5: uint32_t = (x4 >> 25 as std::os::raw::c_int)
        .wrapping_add(*arg1.offset(4 as std::os::raw::c_int as isize));
    let x6: uint32_t = (x5 >> 26 as std::os::raw::c_int)
        .wrapping_add(*arg1.offset(5 as std::os::raw::c_int as isize));
    let x7: uint32_t = (x6 >> 25 as std::os::raw::c_int)
        .wrapping_add(*arg1.offset(6 as std::os::raw::c_int as isize));
    let x8: uint32_t = (x7 >> 26 as std::os::raw::c_int)
        .wrapping_add(*arg1.offset(7 as std::os::raw::c_int as isize));
    let x9: uint32_t = (x8 >> 25 as std::os::raw::c_int)
        .wrapping_add(*arg1.offset(8 as std::os::raw::c_int as isize));
    let x10: uint32_t = (x9 >> 26 as std::os::raw::c_int)
        .wrapping_add(*arg1.offset(9 as std::os::raw::c_int as isize));
    let x11: uint32_t = (x1 & 0x3ffffff as std::os::raw::c_uint).wrapping_add(
        (x10 >> 25 as std::os::raw::c_int)
            .wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint),
    );
    let x12: uint32_t = ((x11 >> 26 as std::os::raw::c_int) as fiat_25519_uint1
        as std::os::raw::c_uint)
        .wrapping_add(x2 & 0x1ffffff as std::os::raw::c_uint);
    let x13: uint32_t = x11 & 0x3ffffff as std::os::raw::c_uint;
    let x14: uint32_t = x12 & 0x1ffffff as std::os::raw::c_uint;
    let x15: uint32_t = ((x12 >> 25 as std::os::raw::c_int) as fiat_25519_uint1
        as std::os::raw::c_uint)
        .wrapping_add(x3 & 0x3ffffff as std::os::raw::c_uint);
    let x16: uint32_t = x4 & 0x1ffffff as std::os::raw::c_uint;
    let x17: uint32_t = x5 & 0x3ffffff as std::os::raw::c_uint;
    let x18: uint32_t = x6 & 0x1ffffff as std::os::raw::c_uint;
    let x19: uint32_t = x7 & 0x3ffffff as std::os::raw::c_uint;
    let x20: uint32_t = x8 & 0x1ffffff as std::os::raw::c_uint;
    let x21: uint32_t = x9 & 0x3ffffff as std::os::raw::c_uint;
    let x22: uint32_t = x10 & 0x1ffffff as std::os::raw::c_uint;
...
unsafe extern "C" fn fiat_25519_add(
    ...
    let x2: uint32_t = (*arg1.offset(1 as std::os::raw::c_int as isize))
        .wrapping_add(*arg2.offset(1 as std::os::raw::c_int as isize));
    let x3: uint32_t = (*arg1.offset(2 as std::os::raw::c_int as isize))
        .wrapping_add(*arg2.offset(2 as std::os::raw::c_int as isize));
    let x4: uint32_t = (*arg1.offset(3 as std::os::raw::c_int as isize))
        .wrapping_add(*arg2.offset(3 as std::os::raw::c_int as isize));
    let x5: uint32_t = (*arg1.offset(4 as std::os::raw::c_int as isize))
        .wrapping_add(*arg2.offset(4 as std::os::raw::c_int as isize));
    let x6: uint32_t = (*arg1.offset(5 as std::os::raw::c_int as isize))
        .wrapping_add(*arg2.offset(5 as std::os::raw::c_int as isize));
    let x7: uint32_t = (*arg1.offset(6 as std::os::raw::c_int as isize))
        .wrapping_add(*arg2.offset(6 as std::os::raw::c_int as isize));
    let x8: uint32_t = (*arg1.offset(7 as std::os::raw::c_int as isize))
        .wrapping_add(*arg2.offset(7 as std::os::raw::c_int as isize));
    let x9: uint32_t = (*arg1.offset(8 as std::os::raw::c_int as isize))
        .wrapping_add(*arg2.offset(8 as std::os::raw::c_int as isize));
    let x10: uint32_t = (*arg1.offset(9 as std::os::raw::c_int as isize))
...
unsafe extern "C" fn fiat_25519_to_bytes(out1: *mut uint8_t, arg1: *const uint32_t) {
    ...
    let x42: uint32_t = x40 << 6 as std::os::raw::c_int;
    let x43: uint32_t = x38 << 4 as std::os::raw::c_int;
    let x44: uint32_t = x36 << 3 as std::os::raw::c_int;
    let x45: uint32_t = x34.wrapping_mul(0x2 as std::os::raw::c_int as uint32_t);
    let x46: uint32_t = x30 << 6 as std::os::raw::c_int;
    let x47: uint32_t = x28 << 5 as std::os::raw::c_int;
    let x48: uint32_t = x26 << 3 as std::os::raw::c_int;
    let x49: uint32_t = x24 << 2 as std::os::raw::c_int;
    let x50: uint32_t = x22 >> 8 as std::os::raw::c_int;
    let x51: uint8_t = (x22 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x52: uint32_t = x50 >> 8 as std::os::raw::c_int;
    let x53: uint8_t = (x50 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x54: uint8_t = (x52 >> 8 as std::os::raw::c_int) as uint8_t;
    let x55: uint8_t = (x52 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x56: uint32_t = (x54 as std::os::raw::c_uint).wrapping_add(x49);
    let x57: uint32_t = x56 >> 8 as std::os::raw::c_int;
    let x58: uint8_t = (x56 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x59: uint32_t = x57 >> 8 as std::os::raw::c_int;
    let x60: uint8_t = (x57 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x61: uint8_t = (x59 >> 8 as std::os::raw::c_int) as uint8_t;
    let x62: uint8_t = (x59 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x63: uint32_t = (x61 as std::os::raw::c_uint).wrapping_add(x48);
    let x64: uint32_t = x63 >> 8 as std::os::raw::c_int;
    let x65: uint8_t = (x63 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x66: uint32_t = x64 >> 8 as std::os::raw::c_int;
    let x67: uint8_t = (x64 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x68: uint8_t = (x66 >> 8 as std::os::raw::c_int) as uint8_t;
    let x69: uint8_t = (x66 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x70: uint32_t = (x68 as std::os::raw::c_uint).wrapping_add(x47);
    let x71: uint32_t = x70 >> 8 as std::os::raw::c_int;
    let x72: uint8_t = (x70 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x73: uint32_t = x71 >> 8 as std::os::raw::c_int;
    let x74: uint8_t = (x71 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x75: uint8_t = (x73 >> 8 as std::os::raw::c_int) as uint8_t;
    let x76: uint8_t = (x73 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x77: uint32_t = (x75 as std::os::raw::c_uint).wrapping_add(x46);
    let x78: uint32_t = x77 >> 8 as std::os::raw::c_int;
    let x79: uint8_t = (x77 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x80: uint32_t = x78 >> 8 as std::os::raw::c_int;
    let x81: uint8_t = (x78 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x82: uint8_t = (x80 >> 8 as std::os::raw::c_int) as uint8_t;
    let x83: uint8_t = (x80 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x84: uint8_t = (x82 as std::os::raw::c_int & 0xff as std::os::raw::c_int) as uint8_t;
    let x85: uint32_t = x32 >> 8 as std::os::raw::c_int;
    let x86: uint8_t = (x32 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x87: uint32_t = x85 >> 8 as std::os::raw::c_int;
    let x88: uint8_t = (x85 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x89: fiat_25519_uint1 = (x87 >> 8 as std::os::raw::c_int) as fiat_25519_uint1;
    let x90: uint8_t = (x87 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x91: uint32_t = (x89 as std::os::raw::c_uint).wrapping_add(x45);
    let x92: uint32_t = x91 >> 8 as std::os::raw::c_int;
    let x93: uint8_t = (x91 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x94: uint32_t = x92 >> 8 as std::os::raw::c_int;
    let x95: uint8_t = (x92 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x96: uint8_t = (x94 >> 8 as std::os::raw::c_int) as uint8_t;
    let x97: uint8_t = (x94 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x98: uint32_t = (x96 as std::os::raw::c_uint).wrapping_add(x44);
    let x99: uint32_t = x98 >> 8 as std::os::raw::c_int;
    let x100: uint8_t = (x98 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x101: uint32_t = x99 >> 8 as std::os::raw::c_int;
    let x102: uint8_t = (x99 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x103: uint8_t = (x101 >> 8 as std::os::raw::c_int) as uint8_t;
    let x104: uint8_t = (x101 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x105: uint32_t = (x103 as std::os::raw::c_uint).wrapping_add(x43);
    let x106: uint32_t = x105 >> 8 as std::os::raw::c_int;
    let x107: uint8_t = (x105 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x108: uint32_t = x106 >> 8 as std::os::raw::c_int;
    let x109: uint8_t = (x106 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x110: uint8_t = (x108 >> 8 as std::os::raw::c_int) as uint8_t;
    let x111: uint8_t = (x108 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x112: uint32_t = (x110 as std::os::raw::c_uint).wrapping_add(x42);
    let x113: uint32_t = x112 >> 8 as std::os::raw::c_int;
    let x114: uint8_t = (x112 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x115: uint32_t = x113 >> 8 as std::os::raw::c_int;
    let x116: uint8_t = (x113 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
    let x117: uint8_t = (x115 >> 8 as std::os::raw::c_int) as uint8_t;
    let x118: uint8_t = (x115 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as uint8_t;
...
unsafe extern "C" fn fiat_25519_from_bytes(out1: *mut uint32_t, arg1: *const uint8_t) {
    ...
    let x16: uint8_t = *arg1.offset(16 as std::os::raw::c_int as isize);
    let x17: uint32_t =
    ...
    let x32: uint8_t = *arg1.offset(0 as std::os::raw::c_int as isize);
    let x33: uint32_t =
        (x32 as std::os::raw::c_uint).wrapping_add(x31.wrapping_add(x30.wrapping_add(x29)));
    let x34: uint8_t = (x33 >> 26 as std::os::raw::c_int) as uint8_t;
    let x35: uint32_t = x33 & 0x3ffffff as std::os::raw::c_uint;
    ...
    let x45: uint32_t = (x34 as std::os::raw::c_uint).wrapping_add(x44);
    let x46: uint8_t = (x45 >> 25 as std::os::raw::c_int) as uint8_t;
    let x47: uint32_t = x45 & 0x1ffffff as std::os::raw::c_uint;
    let x48: uint32_t = (x46 as std::os::raw::c_uint).wrapping_add(x43);
    let x49: uint8_t = (x48 >> 26 as std::os::raw::c_int) as uint8_t;
    let x50: uint32_t = x48 & 0x3ffffff as std::os::raw::c_uint;
    let x51: uint32_t = (x49 as std::os::raw::c_uint).wrapping_add(x42);
    let x52: uint8_t = (x51 >> 25 as std::os::raw::c_int) as uint8_t;
    let x53: uint32_t = x51 & 0x1ffffff as std::os::raw::c_uint;
    let x54: uint32_t = (x52 as std::os::raw::c_uint).wrapping_add(x41);
    let x55: uint32_t = x54 & 0x3ffffff as std::os::raw::c_uint;
    let x56: uint8_t = (x40 >> 25 as std::os::raw::c_int) as uint8_t;
    let x57: uint32_t = x40 & 0x1ffffff as std::os::raw::c_uint;
    let x58: uint32_t = (x56 as std::os::raw::c_uint).wrapping_add(x39);
    let x59: uint8_t = (x58 >> 26 as std::os::raw::c_int) as uint8_t;
    let x60: uint32_t = x58 & 0x3ffffff as std::os::raw::c_uint;
    let x61: uint32_t = (x59 as std::os::raw::c_uint).wrapping_add(x38);
    let x62: uint8_t = (x61 >> 25 as std::os::raw::c_int) as uint8_t;
    let x63: uint32_t = x61 & 0x1ffffff as std::os::raw::c_uint;
    let x64: uint32_t = (x62 as std::os::raw::c_uint).wrapping_add(x37);
    let x65: uint8_t = (x64 >> 26 as std::os::raw::c_int) as uint8_t;
    let x66: uint32_t = x64 & 0x3ffffff as std::os::raw::c_uint;
    let x67: uint32_t = (x65 as std::os::raw::c_uint).wrapping_add(x36);
...
unsafe extern "C" fn fiat_25519_carry_scmul_121666(
    ...
    let x1: uint64_t = (0x1db42 as std::os::raw::c_uint as uint64_t)
        .wrapping_mul(*arg1.offset(9 as std::os::raw::c_int as isize) as u64);
    let x2: uint64_t = (0x1db42 as std::os::raw::c_uint as uint64_t)
        .wrapping_mul(*arg1.offset(8 as std::os::raw::c_int as isize) as u64);
    let x3: uint64_t = (0x1db42 as std::os::raw::c_uint as uint64_t)
        .wrapping_mul(*arg1.offset(7 as std::os::raw::c_int as isize) as u64);
    let x4: uint64_t = (0x1db42 as std::os::raw::c_uint as uint64_t)
        .wrapping_mul(*arg1.offset(6 as std::os::raw::c_int as isize) as u64);
    let x5: uint64_t = (0x1db42 as std::os::raw::c_uint as uint64_t)
        .wrapping_mul(*arg1.offset(5 as std::os::raw::c_int as isize) as u64);
    let x6: uint64_t = (0x1db42 as std::os::raw::c_uint as uint64_t)
        .wrapping_mul(*arg1.offset(4 as std::os::raw::c_int as isize) as u64);
    let x7: uint64_t = (0x1db42 as std::os::raw::c_uint as uint64_t)
        .wrapping_mul(*arg1.offset(3 as std::os::raw::c_int as isize) as u64);
    let x8: uint64_t = (0x1db42 as std::os::raw::c_uint as uint64_t)
        .wrapping_mul(*arg1.offset(2 as std::os::raw::c_int as isize) as u64);
    let x9: uint64_t = (0x1db42 as std::os::raw::c_uint as uint64_t)
        .wrapping_mul(*arg1.offset(1 as std::os::raw::c_int as isize) as u64);
    let x10: uint64_t = (0x1db42 as std::os::raw::c_uint as uint64_t)
        .wrapping_mul(*arg1.offset(0 as std::os::raw::c_int as isize) as u64);
    let x11: uint32_t = (x10 >> 26 as std::os::raw::c_int) as uint32_t;
    let x12: uint32_t = (x10 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x13: uint64_t = (x11 as u64).wrapping_add(x9);
    let x14: uint32_t = (x13 >> 25 as std::os::raw::c_int) as uint32_t;
    let x15: uint32_t = (x13 & 0x1ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x16: uint64_t = (x14 as u64).wrapping_add(x8);
    let x17: uint32_t = (x16 >> 26 as std::os::raw::c_int) as uint32_t;
    let x18: uint32_t = (x16 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x19: uint64_t = (x17 as u64).wrapping_add(x7);
    let x20: uint32_t = (x19 >> 25 as std::os::raw::c_int) as uint32_t;
    let x21: uint32_t = (x19 & 0x1ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x22: uint64_t = (x20 as u64).wrapping_add(x6);
    let x23: uint32_t = (x22 >> 26 as std::os::raw::c_int) as uint32_t;
    let x24: uint32_t = (x22 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x25: uint64_t = (x23 as u64).wrapping_add(x5);
    let x26: uint32_t = (x25 >> 25 as std::os::raw::c_int) as uint32_t;
    let x27: uint32_t = (x25 & 0x1ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x28: uint64_t = (x26 as u64).wrapping_add(x4);
    let x29: uint32_t = (x28 >> 26 as std::os::raw::c_int) as uint32_t;
    let x30: uint32_t = (x28 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x31: uint64_t = (x29 as u64).wrapping_add(x3);
    let x32: uint32_t = (x31 >> 25 as std::os::raw::c_int) as uint32_t;
    let x33: uint32_t = (x31 & 0x1ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x34: uint64_t = (x32 as u64).wrapping_add(x2);
    let x35: uint32_t = (x34 >> 26 as std::os::raw::c_int) as uint32_t;
    let x36: uint32_t = (x34 & 0x3ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x37: uint64_t = (x35 as u64).wrapping_add(x1);
    let x38: uint32_t = (x37 >> 25 as std::os::raw::c_int) as uint32_t;
    let x39: uint32_t = (x37 & 0x1ffffff as std::os::raw::c_uint as u64) as uint32_t;
    let x40: uint32_t = x38.wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint);
    let x41: uint32_t = x12.wrapping_add(x40);
    let x42: fiat_25519_uint1 = (x41 >> 26 as std::os::raw::c_int) as fiat_25519_uint1;
    let x43: uint32_t = x41 & 0x3ffffff as std::os::raw::c_uint;
    let x44: uint32_t = (x42 as std::os::raw::c_uint).wrapping_add(x15);
    let x45: fiat_25519_uint1 = (x44 >> 25 as std::os::raw::c_int) as fiat_25519_uint1;
    let x46: uint32_t = x44 & 0x1ffffff as std::os::raw::c_uint;
    let x47: uint32_t = (x45 as std::os::raw::c_uint).wrapping_add(x18);
...
unsafe extern "C" fn fe_isnonzero(f: *const fe_loose) -> std::os::raw::c_int {
...
unsafe extern "C" fn fe_isnegative(f: *const fe) -> std::os::raw::c_int {
    let mut s: [uint8_t; 32] = [0; 32];
...
unsafe extern "C" fn equal(b: std::os::raw::c_schar, c: std::os::raw::c_schar) -> uint8_t {
    let ub: uint8_t = b as uint8_t;
    let uc: uint8_t = c as uint8_t;
    let x: uint8_t = (ub as std::os::raw::c_int ^ uc as std::os::raw::c_int) as uint8_t;
...
unsafe extern "C" fn negative(b: std::os::raw::c_schar) -> uint8_t {
...
unsafe extern "C" fn table_select(
    ...
    let babs: uint8_t = (b as std::os::raw::c_int
